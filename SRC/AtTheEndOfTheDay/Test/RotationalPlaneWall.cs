...
namespace AlumnoEjemplos.SRC.AtTheEndOfTheDay.Test
{
    ...
    /// </summary>
    public class RotationalPlaneWall : IRenderObject
    {
        ...
        public RotationalPlaneWall(Vector3 origin, Vector3 size, Orientations orientation, TgcTexture texture, float uTile, float vTile)
            : this()
        {
            setTexture(texture);
        ...
        /// <param name="orientation">Orientacion de la pared</param>
        /// <param name="texture">Textura de la pared</param>
        public RotationalPlaneWall(Vector3 origin, Vector3 size, Orientations orientation, TgcTexture texture)
            : this()
        {
            setTexture(texture);
