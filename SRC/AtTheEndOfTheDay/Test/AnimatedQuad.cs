...
namespace AlumnoEjemplos.SRC.AtTheEndOfTheDay.Test
{
    class AnimatedQuad
    {
        ...
        */
        ...
        public AnimatedQuad(string texturePath, Size frameSize, int totalFrames, float frameRate, Vector3 wallSize, Vector3 positionWall, int firstFrame)
        {
            this.enabled = false;
            ...
            */
            //Wall
            texturedQuad = new TexturedQuad(positionWall, wallSize, Vector3.Empty, texture, uTile, vTile);
